...
console.warn(`Music type "${musicType}" not found or not loaded`);
return;
}

if (!this.currentMusic) {
console.warn(`Music not loaded for type: ${musicType}`);
...
console.warn('Failed to play music (may require user interaction):', err);
