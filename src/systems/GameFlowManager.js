...
console.warn('Game already started, ignoring startGame() call');
return;
}
...
console.warn('Failed to preload ammo pickup models:', error);
});
...
console.warn('Failed to preload first scene models:', error);
});
}
