...
console.log('No object clicked - cannot place point');
}
}
...
console.log('No rail points to export');
return;
}
...
console.log('🗑 All rail points cleared');
}
...
console.log('No object clicked - cannot teleport');
}
}
...
console.log('No ground found, creating fallback');
